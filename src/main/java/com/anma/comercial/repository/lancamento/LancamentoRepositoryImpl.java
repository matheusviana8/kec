...
import com.anma.comercial.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public List<LancamentoEstatisticaCliente> porCliente(LocalDate inicio, LocalDate fim) {
		...
		CriteriaQuery<LancamentoEstatisticaCliente> criteriaQuery = criteriaBuilder.
				createQuery(LancamentoEstatisticaCliente.class);
		
		Root<Lancamento> root = criteriaQuery.from(Lancamento.class);
		
		criteriaQuery.select(criteriaBuilder.construct(LancamentoEstatisticaCliente.class, 
		...
		TypedQuery<LancamentoEstatisticaCliente> typedQuery = manager
